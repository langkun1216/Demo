...
public class JsonUtils {
	 ...
	 * @return
	 */
	public static String toJSONString1(Object object) {
    ...
    public static String getJsonString(){
        String path = JsonUtils.class.getClassLoader().getResource("/data.json").getPath().replace("%20", " ");
    ...
    /**
     * 通过businesstype获取本地json文件相关数据
     * 
     * @param businesstype 工作流类别
     * @return
     */
	public static HashMap<String, Object> getWorkFlowDate(String businesstype){
        JSONObject jsonObject = JSONObject.fromObject(getJsonString());
		JSONArray jsonArray = JSONArray.fromObject(jsonObject.get("dataList"));
		List<HashMap<String, Object>> dataList = (List<HashMap<String, Object>>) jsonArray;
		HashMap<String, Object> result = new HashMap<String, Object>();
		for(int i=0;i<dataList.size();i++){
			HashMap<String, Object> jObj = JsonUtils.toHashMap(dataList.get(i));
			if (jObj.get("businesstype").equals(businesstype)) {
				result = jObj;
			}	
		}
		return result;		
